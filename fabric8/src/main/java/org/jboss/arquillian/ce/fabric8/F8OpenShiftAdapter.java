...
import io.fabric8.kubernetes.api.model.v2_6.ExecAction;
import io.fabric8.kubernetes.api.model.v2_6.HTTPGetAction;
import io.fabric8.kubernetes.api.model.v2_6.Handler;
import io.fabric8.kubernetes.api.model.v2_6.HasMetadata;
import io.fabric8.kubernetes.api.model.v2_6.IntOrString;
...
import io.fabric8.kubernetes.api.model.v2_6.PodSpec;
...
import io.fabric8.kubernetes.api.model.v2_6.ReplicationControllerSpec;
import io.fabric8.kubernetes.api.model.v2_6.Secret;
import io.fabric8.kubernetes.api.model.v2_6.SecretVolumeSource;
...
import io.fabric8.kubernetes.api.model.v2_6.Volume;
import io.fabric8.kubernetes.api.model.v2_6.VolumeMount;
import io.fabric8.kubernetes.clnt.v2_6.dsl.Deletable;
import io.fabric8.kubernetes.clnt.v2_6.dsl.ExecListener;
...
import io.fabric8.openshift.api.model.v2_6.BuildList;
...
import io.fabric8.openshift.api.model.v2_6.DeploymentConfigStatus;
import io.fabric8.openshift.api.model.v2_6.DoneableDeploymentConfig;
import io.fabric8.openshift.api.model.v2_6.DoneableTemplate;
import io.fabric8.openshift.api.model.v2_6.ImageStream;
import io.fabric8.openshift.api.model.v2_6.Project;
import io.fabric8.openshift.api.model.v2_6.RoleBinding;
import io.fabric8.openshift.api.model.v2_6.RoleBindingBuilder;
import io.fabric8.openshift.api.model.v2_6.Route;
import io.fabric8.openshift.api.model.v2_6.Template;
...
import io.fabric8.openshift.clnt.v2_6.OpenShiftConfigBuilder;
import io.fabric8.openshift.clnt.v2_6.ParameterValue;
import io.fabric8.openshift.clnt.v2_6.dsl.DeployableScalableResource;
import io.fabric8.openshift.clnt.v2_6.dsl.TemplateResource;
