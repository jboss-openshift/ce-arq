...
import org.jboss.test.arquillian.ce.jdg.query.deployment.Person;
import org.jboss.test.arquillian.ce.jdg.query.deployment.PersonMarshaller;
import org.jboss.test.arquillian.ce.jdg.query.deployment.PhoneNumberMarshaller;
import org.jboss.test.arquillian.ce.jdg.query.deployment.PhoneTypeMarshaller;
...
public class JdgQueryTest {
    ...
    public static WebArchive getDeployment() {
        ...
        war.addAsLibraries(
                Maven.resolver()
                        .resolve("org.infinispan:infinispan-query-dsl:6.3.1.Final-redhat-1")
                        .withTransitivity()
                        .asFile());
        war.addAsLibraries(
                Maven.resolver()
                        .resolve("org.infinispan:infinispan-remote-query-client:6.3.1.Final-redhat-1")
                        .withTransitivity()
                        .asFile());
        return war;
    }
    ...
    public void testQueryThroughHotRodService() throws Exception {
        ...
        registerSchemasAndMarshallers(cacheManager, cache);
     ...
     * @param cache
     */
    private void registerSchemasAndMarshallers(RemoteCacheManager cacheManager, RemoteCache<Object, Object> cache) throws IOException {
