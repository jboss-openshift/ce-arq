...
public class RunInPodContext {
    ...
    private ParallelHandle parallelHandle;

    public RunInPodContext(Configuration configuration, ParallelHandle parallelHandle) {
    ...
    public ParallelHandle getParallelHandle() {
